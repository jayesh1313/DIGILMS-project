...
import '../../stylesheet/javaa.css'
export default function Javaa() {
  return (
    <div>
  ...
  <div id="content">
    <div class="hipsum"><p>Take a top-rated Java course on LMS to gain in-demand skills. Learn how to build with Java using the latest and greatest tools and techniques. Real-world experts give you training, resources, and coding exercises to help you grow your knowledge..</p>
    <p>Java is one of the most in-demand computer programming languages. It’s used in web applications from e-commerce websites to Android apps. If you want to be a programmer or work with programmers, taking a Java course will help you skill up for the job. Explore our wide range of up-to-date, top-rated Java courses. From primers to certification courses, we’ve got you covered..</p>
